...
<body class="flex flex-row">
    ...
    <div class="flex flex-col">
        <a href="{{ route('dosenDataMaterialCreate') }}">
            <button type="button"
        ...
        <table class="border-black border border-black-100 m-5 w-screen ">
            <thead class="border-black border border-black-100">
                <tr>
                    ...
                    <th class="border-black border border-black-100 px-6 py-3">Name</th>
                    <th class="border-black border border-black-100 px-6 py-3">Description</th>
                    <th class="border-black border border-black-100 px-6 py-3">Is Exam</th>
                    <th class="border-black border border-black-100 px-6 py-3">Path</th>
            ...
            <tbody class="border-black border border-black-100">
                @foreach ($materials as $material)
                    <tr>
                        <td class="border-black border border-black-100 px-6 py-4">{{ $material->id }}</td>
                        <td class="border-black border border-black-100 px-6 py-4">{{ $material->name }}</td>
                        <td class="border-black border border-black-100 px-6 py-4">{{ $material->description }}</td>
                        <td class="border-black border border-black-100 px-6 py-4">{{ $material->is_exam }}</td>
                        <td class="border-black border border-black-100 px-6 py-4">{{ $material->path }}</td>
                        <td class="border-black border border-black-100 px-6 py-4">{{ $material->order }}</td>
                        <td class="border-black border border-black-100 px-6 py-4">
                            <div class="flex flex-row">
                                <a href="{{ route('dosenDataMaterialEdit', $material->id) }}"
                                ...
                                <form action="{{ route('dosenDataMaterialDelete', $material->id) }}" method="POST"
