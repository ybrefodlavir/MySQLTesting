...
<body class="flex flex-row">
    ...
    <div class="m-10">
        ...
        @endif
        <form action="{{ route('dosenBankSoalStore') }}" method="POST">
            @csrf
            <div class="mb-6">
                <label for="question" class="block mb-2 text-sm font-medium">Question</label>
                <textarea rows="6" cols="100" name="question" id="" placeholder="write the question here"></textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="validation_statement" id="" cols="100" rows="6"
                    placeholder="write the validation statement here"></textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="validation_value" id="" cols="100" rows="6"
                    placeholder="write the validation value here"></textarea>
            </div>
