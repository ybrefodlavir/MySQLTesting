...
<body class="flex flex-row">
    ...
    <div class="m-10">
        ...
        @endif
        <form action="{{ route('dosenDataMaterialStore') }}" method="POST">
            @csrf
            <div class="mb-6">
                <label for="name" class="block mb-2 text-sm font-medium">Name</label>
                <input type="text" name="name" id="" placeholder="write the material name here"
                    class="w-96">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="description" id=""
                    placeholder="write the material description here" class="w-96">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="path" id="" placeholder="write the material path here"
                    class="w-96">
            </div>
